...
function SubscriptionsForm() {
    ...
    const submissionData = {
        ...
        drs_submission: {
            ...
            // customer_id: -1,
            // payment_id: -1,
            salesperson_name: formData.salesperson,
            submission_email: formData.email
        }
    };
    ...
    const handleSaveData = async () => {
        try {
            ...
            await axios.post('http://localhost:8000/drs_submissions', submissionData);
    ...
    const SUBSCRIPTIONS = [
        ...
        { id: 4, name: 'SF2/SF3 | 2 Years', cost: 1800},
    ...
    return (
        <form className = "service-form" onSubmit={handleCalculate}>
            ...
            <div className="form-section">
                ...
                <input type="text" name="business" value={formData.business} onChange={handleChange} placeholder="Business" />
